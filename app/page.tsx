      ...
      <div style={{ background: T.header, padding: "0 32px" }}>
        <div style={{ maxWidth: 680, margin: "0 auto", padding: "16px 0 0" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
            ...
            <div style={{ fontSize: 90, opacity: 0.1, transform: "rotate(-10deg)", lineHeight: 1, marginBottom: 16 }}>✈</div>
          </div>
        </div>
      </div>

      {/* Wave */}
      <svg viewBox="0 0 680 36" xmlns="http://www.w3.org/2000/svg" style={{ display: "block", background: T.bg }}>
        <path d="M0 0 L680 0 L680 36 Q340 4 0 36 Z" fill={T.header}/>
      </svg>

      {/* Quiz list */}
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "8px 32px 40px" }}>
        ...
        <div style={{ textAlign: "center", marginTop: 32, fontSize: 12, color: T.muted }}>
          made with ✈️ &amp; probably too much Red Bull — <span style={{ color: T.header, fontWeight: 600 }}>by Sarah</span> 🫶
        </div>
      </div>
    </div>
  );
